...
[Rust](/rust/rust "Rust es un lenguaje de programación de sistemas enfocado en seguridad, concurrencia y rendimiento sin recolector de basura (GC).") usa traits y `Box<dyn Product>`. [Go](/go/go "Go es un lenguaje compilado, concurrente y de tipado estático creado por Google.") usa interfaces y funciones constructoras. C++ usa templates o punteros inteligentes.
