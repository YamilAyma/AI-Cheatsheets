...
* **Reflexión invoca constructor privado**: Frameworks de test o DI bypassean la visibilidad y crean instancias adicionales.
  * Fix: Lanza excepción en constructor si `instance != null`. En Java/C#, usa SecurityManager o atributos de restricción si el entorno lo permite.
