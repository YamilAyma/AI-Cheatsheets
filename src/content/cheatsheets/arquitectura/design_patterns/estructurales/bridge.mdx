...
La arquitectura sigue un flujo estricto de separación de responsabilidades y delegación controlada. El patrón garantiza que ningún cambio en la plataforma afecte la [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") de dominio, y viceversa.
...
| **Bridge con Validación de Capacidades** | `impl.supports(feature)` antes de delegar. | Motores con diferencias de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") (WebGL 1 vs 2, SQLite vs PostgreSQL). | Overhead en llamadas. Requiere contrato de features explícito. |
...
* **Separe Ejes de Variación Claramente**: Documente qué cambia en la abstracción (dominio/[API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.")) y qué cambia en el implementor (plataforma/tecnología). Mantenga las capas puras.
