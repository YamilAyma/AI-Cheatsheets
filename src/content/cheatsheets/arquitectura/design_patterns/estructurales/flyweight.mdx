...
* **Prefiera Structural Sharing Nativo**: Si el lenguaje soporta (Rust `Arc`, Clojure persistent vectors, JS `structuredClone` + cache), úselo en lugar de reinventar factory.
