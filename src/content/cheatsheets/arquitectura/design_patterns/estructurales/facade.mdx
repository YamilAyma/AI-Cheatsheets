...
| **Facade + [Adapter](/arquitectura/design_patterns/estructurales/adapter "El patrón Adapter es un patrón estructural que permite la cooperación entre objetos con interfaces incompatibles, actuando como un traductor o puente que convierte las llamadas de un contrato a otro.") Híbrido** | Simplifica + traduce incompatibilidades de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") o protocolos. | Integración de vendors con contratos divergentes bajo una API cohesiva. | Doble responsabilidad. Puede violar Single Responsibility si no se delimita. |
...
|------------------|-------------------|
| Integrar subsistemas complejos, librerías terceras o microservicios fragmentados | El subsistema ya expone una [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") simple y cohesiva. Usa referencia directa. |
...
| Trabajas con bounded contexts, [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") boundaries o módulos de alta cohesión interna | La abstracción oculta capacidades críticas y fuerza al cliente a hacer workarounds complejos. |
