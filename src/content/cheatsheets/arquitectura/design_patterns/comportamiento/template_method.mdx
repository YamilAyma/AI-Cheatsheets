...
* **Confundir con Strategy o Command**: Usar Template Method para variar algoritmos completos o para encolar peticiones.
  * Fix: Si varía lógica completa &rarr; Strategy. Si encapsula petición ejecutable &rarr; Command. Si define flujo fijo con pasos extensibles &rarr; Template Method.
