...
| **Chain/Composite** | Combina múltiples estrategias secuencial o condicionalmente. | Pipelines de validación, reglas de negocio anidadas, scoring ponderado. | Overhead de iteración. Puede oscurecer trazabilidad si no se loguea. |
...
* **Confundir con State o Template Method**: Usar Strategy para gestionar ciclo de vida o para definir esqueleto de algoritmo con herencia.
  * Fix: Si varía por estado interno &rarr; State. Si hereda flujo fijo &rarr; Template Method. Si reemplaza algoritmo completo &rarr; Strategy.
