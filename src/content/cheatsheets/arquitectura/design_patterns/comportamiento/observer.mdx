...
| **Distributed/Event Bus** | Notificación vía message broker (Kafka, RabbitMQ, [Redis](/base_datos/nosql/redis "Redis es un almacén de datos en memoria, de código abierto y alto rendimiento, que actúa como base de datos, caché, broker de mensajes y motor de streaming.")). | Microservicios, event sourcing, sistemas multi-tenant o cross-process. | Latencia de red, garantía de entrega (at-least-once), serialización estricta. |
