---
title: "state"
description: "El patrón State es un patrón de comportamiento que permite a un objeto alterar su comportamiento cuando su estado interno cambia, haciendo que parezca que el objeto cambia de clase."
...
| **Immutable/Functional** | Cada transición retorna nuevo estado. Sin mutación. | [Redux](/web/frontend/general/react/redux "Redux es una librería de JavaScript para gestionar el estado de la aplicación."), Event Sourcing, sistemas deterministas, time-travel debugging. | Presión en GC/memoria. Requiere structural sharing para eficiencia. |
...
* **Prefiera Declaración sobre Implementación Manual**: Cuando &gt; 5 estados, use statecharts, tablas JSON o librerías maduras (XState, Stateless, [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") `transitions`). Centralice validación y debugging.
