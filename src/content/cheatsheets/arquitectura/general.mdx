---
title: "general"
description: "La Arquitectura del Software es la estructura fundamental de un sistema de software y la disciplina para crear tales estructuras."
...
* **Idea Clave**: Similar a la [hexagonal](/arquitectura/hexagonal "La Arquitectura Hexagonal, o Arquitectura de Puertos y Adaptadores, es un patrón de diseño de software creado por Alistair Cockburn."), pero a menudo más explícita en la subdivisión de las capas internas (Dominio, Servicios de Dominio, Servicios de Aplicación, Infraestructura).
...
* **Descripción**: Una síntesis de varias arquitecturas concéntricas ([Hexagonal](/arquitectura/hexagonal "La Arquitectura Hexagonal, o Arquitectura de Puertos y Adaptadores, es un patrón de diseño de software creado por Alistair Cockburn."), [Cebolla](/arquitectura/cebolla "La Arquitectura Cebolla, propuesta por Jeffrey Palermo, es un patrón de diseño de software que organiza el código en capas concéntricas, similar a las capas de una cebolla.")). Define cuatro capas principales: Entidades, Casos de Uso, Adaptadores de Interfaz, y Frameworks & Drivers. La regla de dependencia rige el flujo de control.
