...
description: "AppleScript y JavaScript for Automation (JXA) son los lenguajes nativos de macOS para automatizar aplicaciones, controlar el sistema operativo y orquestar flujos de trabajo entre apps."
