---
title: "postman"
description: "Postman es una plataforma colaborativa para el desarrollo de APIs."
...
Postman es una plataforma colaborativa para el desarrollo de APIs. Simplifica cada paso del ciclo de vida de la [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí."), desde el diseño y la prueba hasta la publicación y la monitorización. Permite enviar solicitudes HTTP a APIs y ver las respuestas de forma interactiva y visual.

---

## 1. 🌟 Conceptos Clave

* **Solicitud (Request)**: Una petición HTTP enviada a un endpoint de la [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") (ej. GET, POST, PUT, DELETE).
* **Respuesta (Response)**: La información devuelta por el servidor de la [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") en respuesta a una solicitud.
...
* **Servidor Mock (Mock Server)**: Un servidor simulado que imita el comportamiento de una [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") real, devolviendo respuestas predefinidas sin necesidad de un backend real.
* **Monitor**: Permite programar la ejecución de colecciones a intervalos regulares para verificar el rendimiento y la disponibilidad de la [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.").
...
* **Alcance (Scope)**:
  ...
  * **Environment**: Definidas en un Entorno activo. Ideal para URLs base, credenciales de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.").
...
* **Ejecutor de Colecciones (Collection Runner)**: Ejecuta todas las solicitudes en una colección (o carpeta) en orden, con la opción de usar archivos de datos CSV/JSON.
  ...
  * Útil para pruebas de regresión, pruebas de carga básicas, o flujos de trabajo de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.").
