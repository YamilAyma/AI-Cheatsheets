...
*   **Lenguajes Soportados**:
    ...
    *   **R (FastR)**:
        ...
        R my_script.R
        ```
    *   **LLVM bitcode / WebAssembly (wasm)**: Permite ejecutar código compilado de C, C++, [Rust](/rust/rust "Rust es un lenguaje de programación de sistemas enfocado en seguridad, concurrencia y rendimiento sin recolector de basura (GC)."), Go, etc.
        ```bash
