...
*   **Máquina Virtual Universal**: No solo ejecuta [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."), sino también otros lenguajes en el mismo entorno.
*   **Compilador Graal JIT**: Un compilador Just-In-Time (JIT) avanzado que reemplaza al compilador C2 de OpenJDK/HotSpot, ofreciendo optimizaciones más agresivas para [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") y lenguajes basados en JVM.
*   **Native Image (AOT Compilation)**: La capacidad de compilar código [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") (y de otros lenguajes) en un ejecutable nativo **autónomo** y **ligero** que no requiere una JVM instalada. Esto se logra mediante la compilación Ahead-of-Time (AOT).
...
*   **Descripción**: GraalVM puede usarse como un reemplazo de alto rendimiento para tu JDK estándar. El compilador Graal JIT optimiza el código [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") en tiempo de ejecución de manera más agresiva.
*   **Beneficios**: Mayor rendimiento de pico, menor latencia, mejor uso de recursos para aplicaciones [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") de larga ejecución.
*   **Uso**: Simplemente ejecuta tu aplicación [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") con `java`:
    ```bash
    java -jar my_app.jar
    ```
...
*   **Lenguajes Soportados**:
    *   **JavaScript (Graal.js)**: Compatible con Node.js y ECMAScript.
        ...
        ```
    *   **[Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") (GraalPy)**: Implementación de Python 3. (Actualmente no soporta todos los módulos C de CPython).
        ```bash
    ...
    *   **R (FastR)**:
        ...
        R my_script.R
        ```
    *   **LLVM bitcode / WebAssembly (wasm)**: Permite ejecutar código compilado de C, C++, [Rust](/rust/rust "Rust es un lenguaje de programación de sistemas enfocado en seguridad, concurrencia y rendimiento sin recolector de basura (GC)."), [Go](/go/go "Go es un lenguaje compilado, concurrente y de tipado estático creado por Google."), etc.
        ```bash
...
*   **`graalpy`**: Ejecutar código [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.").
