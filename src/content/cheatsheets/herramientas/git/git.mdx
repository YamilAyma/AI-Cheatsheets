...
* **Pull Request / Merge Request**: Mecanismo para proponer cambios de una rama a otra en un repositorio remoto, común en plataformas como [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.').")/GitLab.
...
* **Estrategia de Ramificación**: Elige una estrategia de ramificación (ej. Git Flow, [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.').") Flow) y síguela consistentemente en tu equipo.
