...
description: "AutoHotkey (AHK) es un lenguaje de scripting gratuito y de código abierto para Windows diseñado específicamente para la automatización de la interfaz de usuario, el remapeo de teclas y la creación de macros."
