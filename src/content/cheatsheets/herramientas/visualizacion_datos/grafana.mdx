...
*   **Utiliza KQL/PromQL Directamente**: Si tus datos están en [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene.") o Prometheus, aprende sus respectivos lenguajes de consulta. Grafana los integra perfectamente.
