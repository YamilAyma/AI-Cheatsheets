---
title: "kibana"
description: "Kibana es una interfaz de usuario de código abierto basada en web que permite visualizar y explorar los datos indexados en Elasticsearch."
...
**Kibana** es una interfaz de usuario de código abierto basada en web que permite visualizar y explorar los datos indexados en [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene."). Proporciona potentes capacidades de análisis, visualización y gestión para logs, métricas y datos de aplicaciones, siendo un componente clave de la Elastic Stack (ELK: Elasticsearch, Logstash/Beats, Kibana).

---

## 1. 🌟 Conceptos Clave

*   **[Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene.") Backend**: Kibana funciona exclusivamente con Elasticsearch como su fuente de datos.
*   **Índice (Index)**: Colección lógica de documentos en [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene.").
*   **Patrón de Índice (Index Pattern)**: Una forma de agrupar uno o más índices relacionados en [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene.") para su exploración en Kibana (ej. `logs-*`, `metricbeat-*`).
...
*   **Query DSL (Domain Specific Language)**: El lenguaje de consulta JSON utilizado por [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene."), que Kibana utiliza por debajo para sus búsquedas.
...
1.  **Instalar [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene.") y que esté en ejecución.**
...
*   **Visualize (Visualizar)**:
    ...
    *   **Tipos de Visualizaciones**:
        ...
        *   **TSVB (Time Series Visual [Builder](/arquitectura/design_patterns/creacionales/builder "El patrón Builder es un patrón creacional que separa la construcción de un objeto complejo de su representación final, permitiendo que el mismo proceso de ensamblaje genere diferentes variantes."))**: Para visualizaciones de series de tiempo complejas.
*   **Dashboard (Panel)**:
...
*   **[API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Keys**: Gestionar claves de API.
...
*   **Index Management**: Gestionar índices de [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene.") (ciclo de vida, snapshots).
