---
title: "github"
description: "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.\")."
...
**GitHub** es una plataforma web para el alojamiento de repositorios de control de versiones [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia."). Facilita la colaboración en proyectos de software, la gestión de código, la revisión de código, el seguimiento de problemas y la automatización del flujo de trabajo de desarrollo.

---

## 1. 🌟 Conceptos Clave (GitHub vs. Git)

* **[Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.")**: El **sistema de control de versiones distribuido** (software) que rastrea los cambios en el código localmente.
* **GitHub**: La **plataforma de alojamiento web** que proporciona servicios para repositorios [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia."), permitiendo la colaboración, la gestión de proyectos, y un ecosistema de herramientas adicionales.
* **Repositorio (Repository)**: Un proyecto alojado en GitHub. Contiene todos los archivos del proyecto, su historial de [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia."), y las funcionalidades de GitHub (Issues, PRs, etc.).
...
* **Configurar SSH Keys (Recomendado)**: Para una autenticación segura sin contraseña para las operaciones de [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.").
...
* Si ya tienes un repositorio [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.") local (`git init`):
  ```bash
...
* **Estrategia de Ramificación Consistente**: Adopta y sigue una estrategia de ramas (ej. GitHub Flow para proyectos simples, [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.") Flow para más complejos).
