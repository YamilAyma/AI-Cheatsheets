---
title: "openapi"
description: "OpenAPI Specification (OAS) es un formato de descripción de API es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.\") estándar, independiente del lenguaje, legible tanto por humanos como por máquinas."
...
OpenAPI Specification (OAS) es un formato de descripción de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") estándar, independiente del lenguaje, legible tanto por humanos como por máquinas. Permite describir la estructura y las capacidades de las APIs RESTful de forma declarativa utilizando archivos YAML o JSON.

---

## 1. 🌟 Conceptos Clave

* **[API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") RESTful**: Una interfaz que permite a diferentes sistemas comunicarse utilizando principios REST (transferencia de estado representacional).
* **Descripción Declarativa**: Define la [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") (rutas, operaciones, parámetros, respuestas, modelos de datos) en un archivo estático, en lugar de generarla a partir del código.
* **Interoperabilidad**: Al ser un estándar, permite que diferentes herramientas (documentación, generación de código, pruebas) trabajen con la misma descripción de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.").
...
* **Swagger Codegen**: Genera automáticamente SDKs de cliente y stubs de servidor en varios lenguajes ([Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."), [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos."), [TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad."), [Go](/go/go "Go es un lenguaje compilado, concurrente y de tipado estático creado por Google."), etc.) a partir de una especificación OpenAPI.
* **[Postman](/herramientas/postman "Postman es una plataforma colaborativa para el desarrollo de APIs.") / Insomnia**: Clientes de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") populares que pueden importar especificaciones OpenAPI para generar colecciones de solicitudes, facilitando las pruebas.
* **Spectral**: Un linter de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") que valida tu especificación OpenAPI contra un conjunto de reglas para asegurar la consistencia y las mejores prácticas.
...
* **Sé Explícito y Descriptivo**: Proporciona `summary` y `description` claros y concisos para cada [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí."), ruta y operación.
...
* **Control de Versiones**: Mantén tu especificación OpenAPI versionada junto con tu código fuente (ej. en [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.")). Actualiza la `info.version` con cada cambio significativo.
