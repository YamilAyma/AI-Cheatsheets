...
description: "El .NET Framework es una plataforma de desarrollo de software integral creada por Microsoft."
...
* **"Write Once, Run Anywhere" (WORA)**: Similar a [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."), el código compilado puede ejecutarse en cualquier sistema que tenga el .NET Framework instalado.
...
* **ASP.NET Web [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.")**:
...
* **WCF (Windows Communication Foundation)**:
  ...
  * Considerado obsoleto para nuevos proyectos en favor de ASP.NET Web [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.")/gRPC en .NET.
...
* **[SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") Server Management Studio (SSMS)**: Para gestionar bases de datos SQL Server, comunes en aplicaciones .NET Framework.
...
* **LINQ (Language Integrated Query)**: Permite escribir consultas de datos directamente en el código C# (o VB.NET) para colecciones, bases de datos (LINQ to [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros."), LINQ to Entities) y XML.
