...
* **Event (Evento)**: Una actividad específica en [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.').") que dispara un workflow (ej. `push`, `pull_request`, `issue_comment`, `schedule`).
...
* **Action (Acción)**: Una aplicación empaquetada y reutilizable que realiza una tarea específica (ej. clonar un repositorio, configurar un entorno, publicar un paquete). Pueden ser creadas por la comunidad, por [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.')."), o por ti.
* **Runner (Ejecutor)**: Una máquina virtual (VM) o un contenedor donde se ejecutan tus `jobs`. Pueden ser hosteados por [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.').") (Linux, macOS, Windows) o auto-hosteados.
...
* **`pull_request`**: Se ejecuta cuando se abre o actualiza un Pull Request.
  ...
  ```
* **`workflow_dispatch`**: Permite ejecutar el workflow manualmente desde la interfaz de usuario de [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.').").
  ```yaml
  on:
    workflow_dispatch:
...
* **Hosteados por [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.').")**:
...
* **Protege Secretos**: No los "hardcodees". Almacénalos en [GitHub](/herramientas/github "GitHub es una plataforma web para el alojamiento de repositorios de control de versiones Git diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.').") Secrets y accede a ellos a través de `secrets.<nombre>`.
