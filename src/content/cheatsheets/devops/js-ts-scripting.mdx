...
description: "Scripting moderno con JavaScript y TypeScript usando Bun y Deno: ejecución directa de TS, shell nativo, APIs de sistema de archivos, HTTP y compilación a ejecutables autónomos."
