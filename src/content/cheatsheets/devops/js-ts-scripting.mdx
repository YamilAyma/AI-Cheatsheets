...
El Bun Shell permite ejecutar comandos como si estuvieras en [Bash](/devops/bash "Bash (Bourne Again Shell) es un shell de Unix y lenguaje de comandos compatible con POSIX."), pero con la potencia de [TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.").
...
* **Bun para scripts locales de DevOps**: Ideal para reemplazar scripts [Bash](/devops/bash "Bash (Bourne Again Shell) es un shell de Unix y lenguaje de comandos compatible con POSIX.") complejos donde quieres tipado estático, manejo de errores robusto y acceso a librerías npm.
...
* **Usa `zx` cuando necesites migrar scripts [Bash](/devops/bash "Bash (Bourne Again Shell) es un shell de Unix y lenguaje de comandos compatible con POSIX.") a JS**: La sintaxis de template literals imita Bash y facilita la migración incremental.

* **[TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.") estricto desde el inicio**: Agrega `"strict": true` en `tsconfig.json`. El overhead de tipado se paga por sí solo en la reducción de bugs en scripts de automatización críticos.
...
Este cheatsheet proporciona una referencia exhaustiva de **scripting moderno con JavaScript y [TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.") usando Bun, Deno y zx**, cubriendo desde la instalación y el Bun Shell hasta las APIs de sistema de archivos, HTTP nativo, compilación a ejecutables autónomos y las mejores prácticas para crear scripts de automatización tipados, robustos y multiplataforma.
