...
Este cheatsheet proporciona una referencia exhaustiva de **Lua**, cubriendo desde los fundamentos del lenguaje y la tabla como estructura universal, hasta el sistema de OOP con metatables, coroutines para programación asíncrona cooperativa, y la integración práctica en entornos reales como Neovim, OpenResty y [Redis](/base_datos/nosql/redis "Redis es un almacén de datos en memoria, de código abierto y alto rendimiento, que actúa como base de datos, caché, broker de mensajes y motor de streaming.").
