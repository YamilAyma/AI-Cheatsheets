---
title: "Lua"
description: "Lua es el lenguaje de scripting embebido más rápido y ligero del mundo. Fundamental para extender Neovim, Nginx (OpenResty), Redis, motores de videojuegos y sistemas embebidos."
