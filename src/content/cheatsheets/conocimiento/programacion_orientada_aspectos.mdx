...
*   **[Proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.")**: En algunas implementaciones de AOP (ej. Spring AOP), se crea un objeto "proxy" que envuelve al objeto objetivo y es a través de este proxy que se inyecta el Advice.
...
*   **Post-Compile Weaving (Binary / Load-Time Weaving - LTW)**:
    ...
    *   **Contras**: Requiere un agente [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") configurado en la JVM.
*   **Runtime Weaving ([Proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.")-based)**:
    *   **Cuándo**: En tiempo de ejecución. El framework (ej. Spring AOP) crea objetos "[proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.")" que envuelven a los objetos objetivo. Las llamadas a los métodos del objetivo pasan por el proxy, donde se ejecuta el Advice.
...
*   **[AspectJ](/java/librerias/aspectj "AspectJ es una extensión 'seamless' (sin costuras) de Java que implementa la Programación Orientada a Aspectos (AOP).")**:
    *   El framework de AOP más maduro y potente para [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.").
...
*   **Spring AOP**:
    ...
    *   Más simple de usar que [AspectJ](/java/librerias/aspectj "AspectJ es una extensión 'seamless' (sin costuras) de Java que implementa la Programación Orientada a Aspectos (AOP).") nativo, pero con menos capacidades (principalmente se enfoca en Join Points de ejecución de métodos públicos).
    *   A menudo suficiente para la mayoría de los casos de uso comunes en aplicaciones Spring.
    *   Puede usar [AspectJ](/java/librerias/aspectj "AspectJ es una extensión 'seamless' (sin costuras) de Java que implementa la Programación Orientada a Aspectos (AOP).") como su "backend" de Weaving para capacidades completas de AspectJ si se configura LTW.
*   **PostSharp (.NET)**: Un framework de AOP popular para el ecosistema .NET.
*   **Otros Lenguajes**: Aunque AOP es más prominente en [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.")/.NET, otros lenguajes tienen características similares (ej. decoradores/atributos en [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos."), [TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad."), C++).
...
*   **Impacto en el Rendimiento**: El Weaving (especialmente el de runtime/[proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.")) puede tener una ligera sobrecarga. Mide el rendimiento si es crítico.
