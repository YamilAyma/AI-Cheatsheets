...
* **Idiomaticidad**: No todos los lenguajes están igualmente adaptados a la programación funcional. Algunos (Haskell, Lisp) son puramente funcionales, mientras que otros (JavaScript, Python, [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") 8+) son multiparadigma y permiten FP, pero requieren disciplina.
