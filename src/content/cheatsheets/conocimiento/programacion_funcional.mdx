...
description: "La Programación Funcional es un paradigma de programación que construye software mediante la composición de funciones puras, evitando el estado compartido y los datos mutables."
...
* **Inmutabilidad (Immutability)**:
  ...
  * *Ejemplo (JavaScript/[Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.")):*
    ```javascript
    // Imperativo (mutable)
    let arr = [1, 2, 3];
...
* **Funciones de Primera Clase (First-Class Functions)**:
  ...
  * *Ejemplo ([Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.")):*
    ```python
    def saludar(nombre):
...
* **Recursión (Recursion)**:
  ...
  * *Ejemplo ([Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") - factorial):*
    ```python
    def factorial(n):
...
* **Idiomaticidad**: No todos los lenguajes están igualmente adaptados a la programación funcional. Algunos (Haskell, Lisp) son puramente funcionales, mientras que otros (JavaScript, [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos."), [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") 8+) son multiparadigma y permiten FP, pero requieren disciplina.
