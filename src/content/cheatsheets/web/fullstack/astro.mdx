---
title: "astro"
description: "Astro es un framework web de JavaScript todo-en-uno que te permite construir sitios web rápidos y centrados en el contenido con una experiencia de desarrollo moderna."
...
* **Isla de Interactividad**: Un componente de framework de UI ([React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario."), Vue, [Svelte](/web/frontend/framework/svelte "Svelte es un framework de compilación que traslada el trabajo reactivo a build time, generando código quirúrgico, altamente optimizado y sin Virtual DOM."), etc.) que se carga y ejecuta en el cliente. El resto de la página es HTML estático.
...
* **Agnóstico a frameworks de UI**: Puedes usar tus componentes de [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario."), Vue, [Svelte](/web/frontend/framework/svelte "Svelte es un framework de compilación que traslada el trabajo reactivo a build time, generando código quirúrgico, altamente optimizado y sin Virtual DOM."), Lit, Solid, Preact y Alpine.js (o mezclarlos en la misma página).
...
Permite construir endpoints [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") RESTful o [GraphQL](/conocimiento/graphql "GraphQL es un lenguaje de consulta y runtime para APIs que permite a los clientes solicitar exactamente los datos que necesitan, evitando sobre-fetching y under-fetching.") directamente en tu proyecto Astro.
...
* **Diseño HTML-first**: Siempre que sea posible, construye la UI con componentes Astro (.astro) y HTML puro. Introduce componentes de UI framework ([React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario."), Vue, etc.) solo cuando la interactividad sea estrictamente necesaria.
