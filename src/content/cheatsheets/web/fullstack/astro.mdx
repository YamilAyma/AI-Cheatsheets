...
* **Agnóstico a frameworks de UI**: Puedes usar tus componentes de [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario."), Vue, Svelte, Lit, Solid, Preact y Alpine.js (o mezclarlos en la misma página).
