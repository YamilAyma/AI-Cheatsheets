---
title: "nextjs"
description: "Next.js es un framework de React para producción que ofrece las mejores características de desarrollo (como enrutamiento basado en sistema de archivos, optimización de imágenes, API es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.\") Routes) y de rendimiento (renderizado del lado del servidor, generación estática, división de código)."
...
Next.js es un framework de [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") para producción que ofrece las mejores características de desarrollo (como enrutamiento basado en sistema de archivos, optimización de imágenes, [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Routes) y de rendimiento (renderizado del lado del servidor, generación estática, división de código).
...
* **App Router (por defecto)**: Basado en el directorio `app/`. Utiliza [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") Server Components y Client Components para un control más granular sobre dónde se renderiza el código (servidor vs. cliente).
...
* **[API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Routes**: Permiten crear endpoints API en tu aplicación Next.js, eliminando la necesidad de un backend separado para ciertas funcionalidades.
...
El nuevo sistema de enrutamiento basado en [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") Server Components.
...
* **Archivos de UI Especiales:**
  ...
  * **`error.js`**: UI de error para un segmento de ruta y sus hijos. Captura errores de [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.").
...
* Permiten mutaciones de datos y revalidaciones eficientes sin construir [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Routes manualmente.
...
* Usa `useEffect` con librerías como SWR o [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") Query.
...
Permite crear endpoints [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") RESTful o [GraphQL](/conocimiento/graphql "GraphQL es un lenguaje de consulta y runtime para APIs que permite a los clientes solicitar exactamente los datos que necesitan, evitando sobre-fetching y under-fetching.") en tu aplicación.
...
* **Exporta funciones para métodos HTTP**: `GET`, `POST`, `PUT`, `DELETE`, etc.
  ...
  * **Rutas Dinámicas en [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Routes**: `app/api/users/[id]/route.ts`
    ```typescript
...
Componente de [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") que optimiza las imágenes automáticamente para rendimiento y responsividad.
...
* **Cuándo `'use client'`**: Marca un componente como Client Component solo cuando necesite hooks de [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") (estado, efectos), manejo de eventos interactivo, o APIs del navegador. De lo contrario, déjalo como Server Component.
...
* **Validación de Esquemasy Tipado**: Usa [TypeScript](/web/general/typescript "  TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.") y librerías como [Zod](/web/frontend/general/zod "¡Absolutamente! Zod es una librería increíble para la validación de esquemas y tipos en TypeScript/JavaScript, famosa por su simplicidad y excelente inferencia de tipos.") para validar datos de [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") y formularios.
...
Este cheatsheet te proporciona una referencia completa de Next.js, cubriendo los conceptos esenciales, el App Router, la carga de datos, el enrutamiento, la estilización, las [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Routes y las mejores prácticas. Es una herramienta indispensable para construir aplicaciones web modernas y de alto rendimiento.
