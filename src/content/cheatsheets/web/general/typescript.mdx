---
title: "typescript"
description: "  TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad."
...
* **Documenta tus tipos**: Para tipos complejos o [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") públicas, añade comentarios JSDoc para explicar su propósito.
