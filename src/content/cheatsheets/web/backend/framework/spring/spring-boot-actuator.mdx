...
*   Por defecto, [Spring Security](/web/backend/framework/spring/spring-security "¡Excelente elección! Spring Security es un pilar fundamental para la seguridad en aplicaciones Spring y Spring Boot.") (si está en el classpath) asegurará automáticamente todos los endpoints de Actuator.
...
*   **[Grafana](/herramientas/visualizacion_datos/grafana "Grafana es una herramienta de código abierto para la visualización y analítica de series de tiempo, diseñada para consultar, visualizar, alertar y comprender tus métricas dondequiera que se almacenen.")**: Utiliza Grafana para visualizar las métricas recolectadas por Prometheus.
