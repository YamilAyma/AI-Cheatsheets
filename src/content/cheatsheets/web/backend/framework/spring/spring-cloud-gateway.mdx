...
*   Spring Cloud Gateway se integra con [Spring Security](/web/backend/framework/spring/spring-security "¡Excelente elección! Spring Security es un pilar fundamental para la seguridad en aplicaciones Spring y Spring Boot.") para la autenticación y autorización.
