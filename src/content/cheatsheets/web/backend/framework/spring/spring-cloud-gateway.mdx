...
description: "Spring Cloud Gateway es un framework API es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.\") Gateway construido sobre Spring Framework 5, Spring Boot 2 y Project Reactor."
...
*   **[API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Gateway**: Un punto de entrada único para todos los clientes que acceden a un conjunto de microservicios. Enruta solicitudes a los servicios apropiados.
...
*   **Seguridad**: Asegura tu Gateway con [Spring Security](/web/backend/framework/spring/spring-security "Spring Security es un pilar fundamental para la seguridad en aplicaciones Spring y Spring Boot."). Es el primer punto de defensa.
...
Este cheatsheet te proporciona una referencia completa de Spring Cloud Gateway, cubriendo sus conceptos esenciales, cómo configurarlo, la definición de rutas con predicados y filtros, las integraciones clave, la seguridad y las mejores prácticas para construir un [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") Gateway robusto y escalable en arquitecturas de microservicios.