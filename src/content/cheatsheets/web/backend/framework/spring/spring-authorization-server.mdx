...
**Spring Authorization Server (SAS)** es un proyecto de [Spring Security](/web/backend/framework/spring/spring-security "Spring Security es un pilar fundamental para la seguridad en aplicaciones Spring y Spring Boot.") que implementa la especificación OAuth 2.1 y OpenID Connect 1.0. Permite a las aplicaciones actuar como un **Servidor de Autorización**, emitiendo tokens de acceso a clientes autenticados después de obtener la autorización del propietario del recurso.
