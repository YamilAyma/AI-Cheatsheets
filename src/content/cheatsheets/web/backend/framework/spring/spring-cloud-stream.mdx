...
description: "Spring Cloud Stream es un framework para construir microservicios basados en mensajes."
...
*   **Tipado Fuerte**: Define clases [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") para tus payloads de mensajes. Esto permite que Spring Cloud Stream realice la deserialización automáticamente y ofrece seguridad de tipos.
...
*   **Monitoreo**: Integra Actuator y herramientas de monitoreo ([Prometheus](/web/backend/framework/herramientas/prometheus "Prometheus es una solución de monitoreo de código abierto y sistema de alertado."), [Grafana](/herramientas/visualizacion_datos/grafana "Grafana es una herramienta de código abierto para la visualización y analítica de series de tiempo, diseñada para consultar, visualizar, alertar y comprender tus métricas dondequiera que se almacenen.")) para observar las métricas de tus canales y binders.
