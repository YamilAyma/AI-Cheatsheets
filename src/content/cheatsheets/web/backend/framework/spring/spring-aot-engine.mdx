...
*   **GraalVM Native Image**: La tecnología de GraalVM que compila aplicaciones [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") a ejecutables binarios independientes y ligeros.
