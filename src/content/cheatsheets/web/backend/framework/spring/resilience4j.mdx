---
title: "resilience4j"
description: "Resilience4j es una librería de resiliencia ligera y modular para Java."
...
**Resilience4j** es una librería de resiliencia ligera y modular para [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."). Proporciona patrones de tolerancia a fallos como Circuit Breaker, Rate Limiter, Retry, Bulkhead y Time Limiter para mejorar la fiabilidad y la estabilidad de los microservicios en un entorno distribuido.
...
*   **Decoración de Funciones**: Resilience4j funciona decorando funciones [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") (lambdas, `Callable`, `Supplier`, `Function`, `Consumer`, etc.) para aplicar los patrones.
...
1.  **Añadir dependencias en `pom.xml` (Maven):**
    *   Necesitarás el starter de [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.") para Resilience4j y las dependencias de los módulos específicos de resiliencia que quieras usar.
    ```xml
    <dependencies>
...
*   Resilience4j se integra con Micrometer, lo que permite exponer sus métricas a través de [Spring Boot Actuator](/web/backend/framework/spring/spring-boot-actuator "Spring Boot Actuator es una característica de Spring Boot que proporciona puntos finales ('endpoints') listos para la producción.") (`/actuator/prometheus`).
*   **Métricas Comunes**:
...
*   **Visualización**: Usa [Prometheus](/web/backend/framework/herramientas/prometheus "Prometheus es una solución de monitoreo de código abierto y sistema de alertado.") para recolectar las métricas y [Grafana](/herramientas/visualizacion_datos/grafana "Grafana es una herramienta de código abierto para la visualización y analítica de series de tiempo, diseñada para consultar, visualizar, alertar y comprender tus métricas dondequiera que se almacenen.") para visualizarlas en dashboards.
...
*   **Usa Anotaciones en [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.")**: Son más concisas y legibles que los decoradores funcionales para la mayoría de los casos.
...
Este cheatsheet te proporciona una referencia completa de Resilience4j, cubriendo sus conceptos esenciales de resiliencia, cómo configurarlo en [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente."), el uso de sus anotaciones en código [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."), las métricas clave y las mejores prácticas para construir microservicios robustos y tolerantes a fallos.