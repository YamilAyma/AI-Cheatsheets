...
* **MVT (Model-View-Template)**:
  ...
  * **View**: La capa de lógica de negocio. Recibe una solicitud HTTP, interactúa con el Modelo, y selecciona el Template a renderizar (función o clase [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.")).
  * **Template**: La capa de presentación. Define cómo se muestra la interfaz de usuario (HTML con lógica de plantilla de Django).
* **ORM (Object-Relational Mapper)**: Permite interactuar con tu base de datos utilizando objetos [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos."), sin escribir [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") directamente.
...
3. **Crear un Nuevo Proyecto Django:**
   ...
   * Esto crea:
     * `myproject/` (el paquete raíz de [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") para tu proyecto)
       * `__init__.py`
...
* Cuando modificas `models.py`, necesitas crear y aplicar migraciones.
  ...
  ```bash
  [python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") manage.py makemigrations # Crea un nuevo archivo de migración
  [python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") manage.py migrate       # Aplica la migración a la base de datos
  ```
...
class ContactForm(forms.Form):
    ...
    def [clean](/arquitectura/clean "La Arquitectura Limpia es una filosofía de diseño de software que propone una organización de código basada en capas concéntricas, donde las dependencias siempre apuntan hacia adentro.")(self):
        cleaned_data = super().[clean](/arquitectura/clean "La Arquitectura Limpia es una filosofía de diseño de software que propone una organización de código basada en capas concéntricas, donde las dependencias siempre apuntan hacia adentro.")()
...
* **Recopilar Estáticos para Producción**:
  ...
  ```bash
  [python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") manage.py collectstatic
  ```
