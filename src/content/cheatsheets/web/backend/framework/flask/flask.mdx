---
title: "flask"
description: "Flask es un microframework web para Python que proporciona las herramientas esenciales para construir aplicaciones web, dejando la elección de otras herramientas (como ORM o templating) en manos del desarrollador."
...
Flask es un microframework web para [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") que proporciona las herramientas esenciales para construir aplicaciones web, dejando la elección de otras herramientas (como ORM o templating) en manos del desarrollador. Se basa en el toolkit WSGI (Werkzeug) y el motor de plantillas [Jinja2](/template_engine/jinja2 "Jinja2 es un motor de plantillas (template engine) para Python.").
...
* **[Jinja2](/template_engine/jinja2 "Jinja2 es un motor de plantillas (template engine) para [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.").")**: El motor de plantillas por defecto de Flask para renderizar HTML dinámicamente.
* **Rutas (Routes)**: Mapean las URLs a funciones de [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") que manejan las solicitudes.
* **Vistas (Views)**: Las funciones de [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") que manejan una solicitud entrante y devuelven una respuesta.
...
* **WSGI**: (Web Server Gateway Interface) Un estándar de [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.") para la comunicación entre servidores web y aplicaciones web.
...
* **`request` Objeto**: Global ([proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.") de contexto) que contiene la información de la solicitud HTTP entrante.
...
Flask usa [Jinja2](/template_engine/jinja2 "Jinja2 es un motor de plantillas (template engine) para [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.").") para renderizar plantillas HTML dinámicas.
...
* **`render_template()`**: Función para cargar y renderizar una plantilla.
  ...
  ```
* **Sintaxis [Jinja2](/template_engine/jinja2 "Jinja2 es un motor de plantillas (template engine) para [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos.").") (`templates/index.html`)**:
...
* **Despliegue**: No uses `app.run(debug=True)` en producción. Usa un servidor WSGI como Gunicorn o uWSGI, y un servidor web como [Nginx](/devops/nginx "Nginx (pronunciado 'engine-x') es un servidor web de alto rendimiento, servidor de correo reverso y balanceador de carga HTTP, diseñado para máxima concurrencia, eficiencia de recursos y bajo consumo de memoria.") o Apache como [proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.") inverso.
