---
title: "prometheus"
description: "Prometheus es una solución de monitoreo de código abierto y sistema de alertado."
...
1.  **Prometheus Server**:
    ...
    *   **HTTP Server**: Para la UI, el [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") y los Pushgateway.
...
5.  **Service Discovery**: Prometheus puede descubrir Targets dinámicamente de sistemas como [Kubernetes](/devops/kubernetes "Kubernetes (K8s) es una plataforma portable y extensible de código abierto para gestionar cargas de trabajo y servicios en contenedores."), Consúl, EC2, etc.
...
[Grafana](/herramientas/visualizacion_datos/grafana "Grafana es una herramienta de código abierto para la visualización y analítica de series de tiempo, diseñada para consultar, visualizar, alertar y comprender tus métricas dondequiera que se almacenen.") es la herramienta de visualización de dashboards más popular para Prometheus.

1.  **Instalar [Grafana](/herramientas/visualizacion_datos/grafana "Grafana es una herramienta de código abierto para la visualización y analítica de series de tiempo, diseñada para consultar, visualizar, alertar y comprender tus métricas dondequiera que se almacenen.")**: Sigue las instrucciones de Grafana.
    ```bash
...
3.  **Crear Dashboards**: Crea paneles en [Grafana](/herramientas/visualizacion_datos/grafana "Grafana es una herramienta de código abierto para la visualización y analítica de series de tiempo, diseñada para consultar, visualizar, alertar y comprender tus métricas dondequiera que se almacenen.") y usa PromQL para consultar tus métricas de Prometheus.
