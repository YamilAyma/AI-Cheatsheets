---
title: "kiali"
description: "Kiali es una consola de operaciones para Istio, que proporciona un mapa de la malla de servicios, gráficos de flujo de tráfico, vistas detalladas de la salud de los servicios, y la capacidad de depurar y validar la configuración de Istio."
...
*   **Metrics Integration (Integración de Métricas)**: Utiliza [Prometheus](/web/backend/framework/herramientas/prometheus "Prometheus es una solución de monitoreo de código abierto y sistema de alertado.") (el backend de métricas de Istio) para mostrar métricas detalladas de servicios y cargas de trabajo.
