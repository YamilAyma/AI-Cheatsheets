...
*   **Envoy [Proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.")**: Un proxy de servicio de alto rendimiento, de código abierto, diseñado para lenguajes de programación modernos. Es el proxy por defecto en Istio.
...
*   **Inyección de Sidecar**: El proceso de añadir automáticamente el [proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.") Envoy como un contenedor sidecar a un Pod de [Kubernetes](/devops/kubernetes "Kubernetes (K8s) es una plataforma portable y extensible de código abierto para gestionar cargas de trabajo y servicios en contenedores.").
*   **CRDs (Custom Resource Definitions)**: Istio extiende [Kubernetes](/devops/kubernetes "Kubernetes (K8s) es una plataforma portable y extensible de código abierto para gestionar cargas de trabajo y servicios en contenedores.") añadiendo sus propios tipos de recursos personalizados para configurar sus funcionalidades (ej. `VirtualService`, `Gateway`, `DestinationRule`).
...
2.  **Instalar Istio en [Kubernetes](/devops/kubernetes "Kubernetes (K8s) es una plataforma portable y extensible de código abierto para gestionar cargas de trabajo y servicios en contenedores.") (usando `istioctl`)**:
...
*   **Métricas**: Recopila automáticamente métricas de 4 "golden signals" (latencia, tráfico, errores, saturación) para todos los servicios. Se integra con [Prometheus](/web/backend/framework/herramientas/prometheus "Prometheus es una solución de monitoreo de código abierto y sistema de alertado.") por defecto.
    *   Acceso a [Prometheus](/web/backend/framework/herramientas/prometheus "Prometheus es una solución de monitoreo de código abierto y sistema de alertado.") UI: `istioctl dashboard prometheus`
*   **Trazabilidad Distribuida**: Genera y propaga trazas para el seguimiento de solicitudes a través de múltiples servicios. Se integra con [Jaeger](/web/backend/framework/herramientas/jaeger "Jaeger es un sistema de trazabilidad distribuida de código abierto, inspirado en Dapper de Google y OpenZipkin.") o [Zipkin](/web/backend/framework/spring/zipkin "Zipkin es un sistema de trazabilidad distribuida de código abierto.").
    *   Acceso a [Jaeger](/web/backend/framework/herramientas/jaeger "Jaeger es un sistema de trazabilidad distribuida de código abierto, inspirado en Dapper de Google y OpenZipkin.") UI: `istioctl dashboard jaeger`
    *   Acceso a [Zipkin](/web/backend/framework/spring/zipkin "Zipkin es un sistema de trazabilidad distribuida de código abierto.") UI: `istioctl dashboard zipkin`
...
*   **[Kiali](/web/backend/framework/herramientas/kiali "Kiali es una consola de operaciones para Istio, que proporciona un mapa de la malla de servicios, gráficos de flujo de tráfico, vistas detalladas de la salud de los servicios, y la capacidad de depurar y validar la configuración de Istio.")**: Un panel de control de visualización de mallas de servicios para Istio, que proporciona un mapa gráfico de la malla, métricas, trazas y configuraciones.
    *   Acceso a [Kiali](/web/backend/framework/herramientas/kiali "Kiali es una consola de operaciones para Istio de código abierto que proporciona una capa de infraestructura transparente para gestionar las comunicaciones de servicio a servicio.'), que proporciona un mapa de la malla de servicios, gráficos de flujo de tráfico, vistas detalladas de la salud de los servicios, y la capacidad de depurar y validar la configuración de Istio.") UI: `istioctl dashboard kiali`
...
*   **`Sidecar`**: Controla el comportamiento del [proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.") Envoy para un Pod o un namespace (ej. restringir qué servicios puede alcanzar).
...
*   **Monitorea y Depura con Herramientas de Observabilidad**: Usa [Prometheus](/web/backend/framework/herramientas/prometheus "Prometheus es una solución de monitoreo de código abierto y sistema de alertado."), [Grafana](/herramientas/visualizacion_datos/grafana "Grafana es una herramienta de código abierto para la visualización y analítica de series de tiempo, diseñada para consultar, visualizar, alertar y comprender tus métricas dondequiera que se almacenen."), [Jaeger](/web/backend/framework/herramientas/jaeger "Jaeger es un sistema de trazabilidad distribuida de código abierto, inspirado en Dapper de Google y OpenZipkin.")/[Zipkin](/web/backend/framework/spring/zipkin "Zipkin es un sistema de trazabilidad distribuida de código abierto.") y [Kiali](/web/backend/framework/herramientas/kiali "Kiali es una consola de operaciones para Istio de código abierto que proporciona una capa de infraestructura transparente para gestionar las comunicaciones de servicio a servicio.'), que proporciona un mapa de la malla de servicios, gráficos de flujo de tráfico, vistas detalladas de la salud de los servicios, y la capacidad de depurar y validar la configuración de Istio.") para entender el comportamiento de tu malla. Son indispensables.
...
*   **Aprende el modelo de [Kubernetes](/devops/kubernetes "Kubernetes (K8s) es una plataforma portable y extensible de código abierto para gestionar cargas de trabajo y servicios en contenedores.")**: Un buen entendimiento de Kubernetes es fundamental para usar Istio de manera efectiva.
