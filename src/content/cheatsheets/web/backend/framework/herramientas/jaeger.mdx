...
*   **Jaeger Client**: Librerías específicas de lenguaje ([Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."), Go, [Python](/python/python "Python es un lenguaje de programación de alto nivel, interpretado, interactivo y orientado a objetos."), Node.js, etc.) que instrumentan tu aplicación. Capturan Spans y los envían al Jaeger Agent.
