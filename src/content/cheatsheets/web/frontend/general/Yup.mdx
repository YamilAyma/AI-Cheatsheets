---
title: "Yup"
description: "Yup es una librería de JavaScript para la validación de esquemas."
...
* **Inferencia de Tipos ([TypeScript](/web/general/typescript "  TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad."))**: Yup puede inferir tipos de TypeScript a partir de los esquemas definidos, lo que es muy útil en proyectos TS.
...
Yup tiene una excelente inferencia de tipos con [TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.").
...
Yup es un resolver de validación muy común para [[React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") Hook Form](/web/frontend/general/react/[react-hook-form](/web/frontend/general/react/react-hook-form "React Hook Form es una librería fantástica para la gestión de formularios en React, conocida por su rendimiento y facilidad de uso.") "  React Hook Form es una librería fantástica para la gestión de formularios en React, conocida por su rendimiento y facilidad de uso.").
...
* **`abortEarly: false`**: Para formularios, es útil usar `abortEarly: false` en `validate()` o en el `resolver` de [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") Hook Form para mostrar todos los errores a la vez, no solo el primero.
...
* **Tipado con [TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.")**: Aprovecha `yup.InferType` para obtener tipos TypeScript precisos a partir de tus esquemas.
...
Este cheatsheet te proporciona una referencia completa de Yup, cubriendo sus conceptos esenciales, la definición de esquemas para diferentes tipos de datos, técnicas de validación avanzada, transformaciones y la integración con [[React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") Hook Form](/web/frontend/general/react/[react-hook-form](/web/frontend/general/react/react-hook-form "React Hook Form es una librería fantástica para la gestión de formularios en React, conocida por su rendimiento y facilidad de uso.") "React Hook Form es una librería fantástica para la gestión de formularios en React, conocida por su rendimiento y facilidad de uso."), junto con buenas prácticas para un uso eficaz y robusto.
