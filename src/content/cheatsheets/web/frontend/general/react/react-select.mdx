    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <label>
        ...
        <Controller
          ...
          control={control} // Instancia de control de [React Hook Form](/web/frontend/general/react/react-hook-form "¡Excelente elección! React Hook Form es una librería fantástica para la gestión de formularios en React, conocida por su rendimiento y facilidad de uso.")
