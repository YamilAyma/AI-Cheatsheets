---
title: "react-dnd"
description: "react-dnd es un conjunto de utilidades para crear interfaces de usuario de arrastrar y soltar en React."
...
*   **`key` Prop en Listas**: Asegúrate de que los elementos arrastrables en listas tengan una prop `key` única y estable para ayudar a [React](/web/frontend/general/react/react "¡Excelente! React es la biblioteca de JavaScript más popular para construir interfaces de usuario.") a optimizar el renderizado.
