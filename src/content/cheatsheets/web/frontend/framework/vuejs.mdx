...
* **Options [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") (Legado/Alternativa)**: El enfoque tradicional para organizar la lógica del componente en objetos de opciones (`data`, `methods`, `computed`, `watch`, `lifecycle hooks`).

---

## 2. 🛠️ Configuración Inicial (Vite + Vue)

La forma más recomendada para iniciar un proyecto Vue es con [Vite](/web/frontend/general/vite "Vite es una herramienta de construcción frontend de última generación que combina un servidor de desarrollo ultrarrápido basado en módulos nativos del navegador con un empaquetador de producción optimizado mediante Rollup.").

1. **Crear un Nuevo Proyecto Vue con [Vite](/web/frontend/general/vite "Vite es una herramienta de construcción frontend de última generación que combina un servidor de desarrollo ultrarrápido basado en módulos nativos del navegador con un empaquetador de producción optimizado mediante Rollup."):**
...
Los componentes de un solo archivo (`.vue`) encapsulan template, script y style. El `<script setup>` es el enfoque moderno para usar Composition [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.").
...
* **Usa `<script setup>`**: Es el enfoque moderno y preferido para la Composition [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí."), hace que el código sea más conciso y legible.
...
* **[TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.")**: Considera usar TypeScript con Vue para una mayor seguridad de tipos y una mejor experiencia de desarrollo, especialmente en proyectos grandes.

---

Este cheatsheet te proporciona una referencia completa de Vue.js (Vue 3), cubriendo los conceptos esenciales, la Composition [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí."), el enrutamiento, la gestión de estado y las mejores prácticas para construir aplicaciones web eficientes y escalables.
