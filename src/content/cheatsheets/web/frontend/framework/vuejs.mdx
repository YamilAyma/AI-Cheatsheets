...
Pinia es la solución de gestión de estado recomendada para Vue 3. Es ligera, modular y tiene un excelente soporte de [TypeScript](/web/general/typescript "¡Excelente elección! TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.").
