---
title: "angular"
description: "Angular es un framework de desarrollo de aplicaciones web de código abierto, desarrollado por Google, para construir aplicaciones de una sola página (SPA) y aplicaciones móviles de alto rendimiento."
...
Angular es un framework de desarrollo de aplicaciones web de código abierto, desarrollado por Google, para construir aplicaciones de una sola página (SPA) y aplicaciones móviles de alto rendimiento. Se enfoca en la arquitectura basada en componentes, el tipado estático ([TypeScript](/web/general/typescript "  TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.")) y la reactividad (RxJS).

---

## 1. 🌟 Conceptos Clave

* **Componentes**: Los bloques de construcción fundamentales de una aplicación Angular. Combinan lógica ([TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.")), vista (HTML) y estilo (CSS).
...
* **Servicios**: Clases con lógica de negocio o datos compartidos, que se pueden inyectar en otros componentes o servicios (patrón [Singleton](/arquitectura/design_patterns/creacionales/singleton "El patrón Singleton es un patrón creacional estructural que garantiza que una clase tenga exactamente una instancia en todo el ciclo de vida de un ámbito definido, y proporciona un punto de acceso global a dicha instancia.") por defecto).
...
* **[TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.")**: Lenguaje primario para escribir aplicaciones Angular, que ofrece tipado estático y características de ESNext.

---

## 2. 🛠️ Configuración Inicial (Angular CLI)

Angular CLI ([Command](/arquitectura/design_patterns/comportamiento/command "El patrón Command es un patrón de comportamiento que encapsula una petición o acción como un objeto independiente, desacoplando el emisor de la petición del receptor que la ejecuta.") Line Interface) es la herramienta oficial para inicializar, desarrollar y mantener aplicaciones Angular.
...
* **`@Injectable()`**: Hace que un servicio pueda ser inyectado y también pueda tener otras dependencias inyectadas.
  * `providedIn: 'root'`: El servicio es un [singleton](/arquitectura/design_patterns/creacionales/singleton "El patrón Singleton es un patrón creacional estructural que garantiza que una clase tenga exactamente una instancia en todo el ciclo de vida de un ámbito definido, y proporciona un punto de acceso global a dicha instancia.") disponible en toda la aplicación (preferido).
...
* La lógica se define explícitamente en el componente ([TypeScript](/web/general/typescript "TypeScript es una herramienta fundamental en el desarrollo web moderno, especialmente para proyectos a gran escala, ya que añade seguridad de tipo y mejoras en la productividad.")).
...
* **Optimización de Rendimiento**: Considera `OnPush` change detection [strategy](/arquitectura/design_patterns/comportamiento/strategy "El patrón Strategy es un patrón de comportamiento que define una familia de algoritmos intercambiables, los encapsula y los hace sustituibles en tiempo de ejecución sin alterar el código del cliente que los utiliza."), `trackBy` con `*ngFor`, y lazy loading.
