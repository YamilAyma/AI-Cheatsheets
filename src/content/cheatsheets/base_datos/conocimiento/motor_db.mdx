---
title: "motor_db"
description: "Un Motor de Base de Datos (o Sistema de Gestión de Bases de Datos - SGBD) es el software que permite almacenar, modificar, extraer y gestionar datos en una base de datos."
...
* **Consistencia (Consistency)**:
  * **ACID (Atomicidad, Consistencia, Aislamiento, Durabilidad)**: Conjunto de propiedades que garantizan que las transacciones de bases de datos son procesadas de forma fiable. Crucial para bases de datos transaccionales tradicionales ([SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.")).
  * **BASE (Basically Available, Soft [state](/arquitectura/design_patterns/comportamiento/state "El patrón State es un patrón de comportamiento que permite a un objeto alterar su comportamiento cuando su estado interno cambia, haciendo que parezca que el objeto cambia de clase."), Eventually consistent)**: Un conjunto de propiedades para sistemas NoSQL distribuidos que priorizan la disponibilidad y la tolerancia a particiones sobre la consistencia fuerte.
...
* **[SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") vs. NoSQL**:
  * **[SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") (Relacionales)**: Utilizan SQL para consultas, esquema predefinido, relaciones estrictas entre tablas.
  * **NoSQL (No Relacionales)**: Esquema flexible/dinámico, no usan [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") como lenguaje de consulta principal, modelos de datos variados.
...
* **Características**:
  ...
  * Lenguaje de consulta estándar: [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.").
...
* **Ejemplos Populares**: MySQL, PostgreSQL, Oracle Database, Microsoft [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") Server, SQLite.
...
* **Contras**:
  ...
  * Consultas menos estandarizadas y potentes que [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") para ciertas operaciones.
* **Casos de Uso**:
...
* **Ejemplos Populares**: [MongoDB](/base_datos/nosql/mongodb "MongoDB es una base de datos NoSQL orientada a documentos que almacena datos en formato BSON (Binary JSON), permitiendo esquemas flexibles y escalabilidad horizontal nativa."), Couchbase, DocumentDB, RavenDB.
...
* **Ejemplos Populares**: [Redis](/base_datos/nosql/redis "Redis es un almacén de datos en memoria, de código abierto y alto rendimiento, que actúa como base de datos, caché, broker de mensajes y motor de streaming."), Memcached, DynamoDB (también soporta documentos y columnas), Riak.
...
* **Ejemplos Populares**: [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene."), Apache Solr, Apache Lucene (librería base).
...
* **Contras**:
  * No son adecuadas para datos de propósito [general](/arquitectura/general "La Arquitectura del Software es la estructura fundamental de un sistema de software y la disciplina para crear tales estructuras.").
...
* **Ejemplos Populares**: InfluxDB, TimescaleDB (extensión de PostgreSQL), [Prometheus](/web/backend/framework/herramientas/prometheus "Prometheus es una solución de monitoreo de código abierto y sistema de alertado."), OpenTSDB.
...
* **Justificación**: Para aprovechar las fortalezas específicas de cada tipo de base de datos para diferentes partes de la aplicación.
  * Ej: Una aplicación de e-commerce puede usar:
    ...
    * [MongoDB](/base_datos/nosql/mongodb "MongoDB es una base de datos NoSQL orientada a documentos que almacena datos en formato BSON (Binary JSON), permitiendo esquemas flexibles y escalabilidad horizontal nativa.") para el catálogo de productos (flexibilidad de esquema).
    * [Redis](/base_datos/nosql/redis "Redis es un almacén de datos en memoria, de código abierto y alto rendimiento, que actúa como base de datos, caché, broker de mensajes y motor de streaming.") para caching de sesiones (velocidad).
    * [Elasticsearch](/devops/elasticsearch "Elasticsearch es un motor de búsqueda y análisis distribuido en tiempo real, construido sobre Apache Lucene.") para la búsqueda de productos (full-text search).
