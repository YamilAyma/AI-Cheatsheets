...
* **Tipos**:
  ...
  * **Atributo Compuesto ([Composite](/arquitectura/design_patterns/estructurales/composite "El patrón Composite es un patrón estructural que permite componer objetos en estructuras de árbol para representar jerarquías parte-todo."))**: Se puede dividir en atributos más pequeños y significativos (ej. `Dirección` se compone de `Calle`, `Ciudad`, `Código Postal`). (En Crow's Foot, simplemente se listan los componentes).
