...
description: "¡Claro que sí! Flyway de Redgate es una herramienta poderosa y sencilla para el control de versiones de bases de datos, lo que es crucial en el desarrollo moderno de aplicaciones."
...
Flyway es una herramienta de control de versiones de bases de datos de código abierto que facilita la evolución de tu esquema de base de datos de manera confiable y robusta. Sigue el principio de "migraciones simples". Simplemente escribe tus scripts de migración [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") (o [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.")) y Flyway se encarga de aplicarlos en el orden correcto.

---

## 1. 🌟 Conceptos Clave

* **Migración**: Un script [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") o una clase [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") que realiza cambios en la base de datos (ej. crear una tabla, añadir una columna, insertar datos iniciales).
...
Flyway puede usarse como una herramienta independiente (CLI), con Maven/Gradle, o integrado programáticamente en tu aplicación (ej. [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.")).
...
[Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.") tiene soporte nativo para Flyway. Simplemente añade la dependencia:
...
**Flujo de Trabajo Básico con [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente."):**
...
4. Crea tus scripts [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") dentro de ese directorio siguiendo el formato `V<VERSION>__<DESCRIPTION>.sql`.
5. Inicia tu aplicación [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente."). Flyway detectará automáticamente la base de datos y aplicará las migraciones pendientes.

---

## 3. 📝 Comandos Comunes de Flyway (CLI/Maven/Gradle)

Aunque [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.") lo hace automáticamente, estos son los comandos que Flyway ejecuta o que puedes usar para control manual.

* **`flyway:migrate`**: (Comando principal) Aplica todas las migraciones pendientes que no se han ejecutado en la base de datos.
  * **Automático en [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.") al inicio.**
...
* Permiten realizar tareas de migración complejas que no son posibles con [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") puro (ej. lógica de transformación de datos compleja, llamadas a APIs externas).
...
* **Scripts [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") vs. Migraciones [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.")**:
  * Usa [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") para la mayoría de los cambios de esquema y datos. Son más legibles y fáciles de versionar.
  * Usa migraciones [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") solo para transformaciones de datos complejas o lógica que no se puede expresar fácilmente en [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.").
...
Este cheatsheet te proporciona una base sólida para trabajar con Flyway, cubriendo sus conceptos esenciales, su uso con [Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.") y las mejores prácticas para gestionar de forma eficiente la evolución del esquema de tu base de datos.
