---
title: "php"
description: "PHP es un lenguaje de scripting del lado del servidor, diseñado principalmente para el desarrollo web."
...
* **Lenguaje del Lado del Servidor**: El código PHP se ejecuta en el servidor web (Apache, [Nginx](/devops/nginx "Nginx (pronunciado 'engine-x') es un servidor web de alto rendimiento, servidor de correo reverso y balanceador de carga HTTP, diseñado para máxima concurrencia, eficiencia de recursos y bajo consumo de memoria.")) y genera HTML, CSS, JavaScript que luego se envía al cliente.
...
* **Seguridad**:
  ...
  * **Prepared Statements (PDO)**: Usa consultas preparadas para protegerte de la inyección [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.").
...
* **Control de Versiones**: Usa [Git](/herramientas/git/git "Git es un sistema de control de versiones distribuido (DVCS) diseñado para manejar proyectos pequeños o muy grandes con velocidad y eficiencia.") para el control de versiones de tu código.
