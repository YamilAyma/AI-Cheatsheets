---
title: "mockito"
description: "Mockito es un framework de mocking para pruebas unitarias en Java."
...
**Mockito** es un framework de mocking para pruebas unitarias en [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."). Permite a los desarrolladores crear "objetos mock" (simulados) que reemplazan a las dependencias reales de la clase que se está probando. Esto asegura que las pruebas unitarias sean aisladas, deterministas y rápidas.
...
Para usar Mockito con [JUnit](/java/junit "JUnit es un framework de código abierto para escribir y ejecutar pruebas unitarias en Java.") 5 (recomendado), necesitas las siguientes dependencias en tu `pom.xml`:
...
Este cheatsheet te proporciona una referencia completa de Mockito, cubriendo sus conceptos esenciales, cómo configurar mocks y spys, realizar stubbing, verificar interacciones y aplicar las mejores prácticas para escribir pruebas unitarias de [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") efectivas y robustas.