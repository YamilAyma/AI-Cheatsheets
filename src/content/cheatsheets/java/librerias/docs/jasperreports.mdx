---
title: "jasperreports"
description: "JasperReports es una librería de código abierto y motor de informes más popular en Java."
...
**JasperReports** es una librería de código abierto y motor de informes más popular en [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."). Permite generar informes complejos y altamente personalizables en varios formatos (PDF, HTML, XLS, CSV, DOCX, ODT, RTF, etc.) a partir de diferentes fuentes de datos (JDBC, JavaBeans, XML, CSV, etc.).
...
El proceso [general](/arquitectura/general "La Arquitectura del Software es la estructura fundamental de un sistema de software y la disciplina para crear tales estructuras.") en [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") para generar un informe implica 3 pasos principales: Compilar, Rellenar y Exportar.
...
*   **Evita Queries Complejas en JRXML**: Si la consulta [SQL](/base_datos/sql "SQL es el lenguaje estándar utilizado para comunicarse con y gestionar bases de datos relacionales (RDBMS) como MySQL, PostgreSQL, Oracle, SQL Server, SQLite, entre otros.") se vuelve muy compleja, es mejor procesar los datos en [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") y pasarlos al informe como un `JRBeanCollectionDataSource`.
...
Este cheatsheet te proporciona una referencia completa de JasperReports, cubriendo sus conceptos esenciales, el proceso de generación de informes en [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."), el diseño JRXML, el uso de fuentes de datos, subinformes y las mejores prácticas para crear informes complejos y personalizables.