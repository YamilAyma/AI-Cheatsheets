...
El proceso [general](/arquitectura/general "La Arquitectura del Software es la estructura fundamental de un sistema de software y la disciplina para crear tales estructuras.") en Java para generar un informe implica 3 pasos principales: Compilar, Rellenar y Exportar.
