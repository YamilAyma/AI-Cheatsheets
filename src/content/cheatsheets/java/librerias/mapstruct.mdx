---
title: "mapstruct"
description: "MapStruct es un generador de código que simplifica la implementación de mapeos de datos entre clases de objetos de Java."
...
**MapStruct** es un generador de código que simplifica la implementación de mapeos de datos entre clases de objetos de [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."). En lugar de usar reflexión en tiempo de ejecución (como [ModelMapper](/java/librerias/modelmapper "ModelMapper es una librería de Java que simplifica el mapeo de objetos de un modelo a otro.") o Dozer), MapStruct genera clases de implementación de mapeo en tiempo de compilación. Esto resulta en código de mapeo completamente seguro para tipos y de alto rendimiento, sin sobrecarga en tiempo de ejecución.

---

## 1. 🌟 Conceptos Clave

*   **Generación de Código en Tiempo de Compilación**: A diferencia de otras librerías de mapeo, MapStruct no usa reflexión. Genera una clase [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") concreta (la implementación del "mapper") durante la fase de compilación de tu proyecto.
*   **Convención sobre Configuración**: MapStruct intenta automáticamente mapear propiedades con nombres y tipos similares.
*   **`@Mapper` Anotación**: La anotación principal que marca una interfaz [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") como una interfaz de mapeo para la cual MapStruct debe generar una implementación.
*   **Mappers**: Son interfaces [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") que definen los métodos de mapeo.
...
*   **Alto Rendimiento**: El código generado es código [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") plano y optimizado, sin sobrecarga de reflexión.
...
*   **Una Instancia de Mapper por Aplicación**: Los mappers generados son seguros para hilos y sin estado. Es eficiente usar una única instancia [singleton](/arquitectura/design_patterns/creacionales/singleton "El patrón Singleton es un patrón creacional estructural que garantiza que una clase tenga exactamente una instancia en todo el ciclo de vida de un ámbito definido, y proporciona un punto de acceso global a dicha instancia.") de cada mapper en tu aplicación.
