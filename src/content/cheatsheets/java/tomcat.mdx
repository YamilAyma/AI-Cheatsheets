---
title: "tomcat"
description: "Apache Tomcat es un servidor web de código abierto y un contenedor de servlets desarrollado por la Apache Software Foundation."
...
**Apache Tomcat** es un servidor web de código abierto y un contenedor de servlets desarrollado por la Apache Software Foundation. Implementa las especificaciones [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") Servlet, JavaServer Pages (JSP), Java Unified Expression Language (JUEL) y Java WebSocket. Es un pilar para el despliegue de aplicaciones web basadas en Java.
...
*   **Contenedor de Servlets**: El componente principal que gestiona el ciclo de vida de los Servlets y JSPs. Proporciona el entorno de ejecución para las aplicaciones web [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.").
*   **Servlet**: Una clase [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") que extiende las capacidades de un servidor, respondiendo a solicitudes HTTP. Es el componente fundamental de las aplicaciones web Java del lado del servidor.
*   **JSP (JavaServer Pages)**: Una tecnología que permite incrustar código [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") directamente en páginas HTML. Similar a [PHP](/php/php "PHP es un lenguaje de scripting del lado del servidor, diseñado principalmente para el desarrollo web."), pero para Java. Se compilan a Servlets.
*   **WAR (Web Application ARchive)**: El formato de archivo estándar para empaquetar una aplicación web [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") completa para su despliegue en un servidor de aplicaciones o contenedor de servlets como Tomcat. Contiene código Java compilado, JSPs, HTML, CSS, JS, recursos e información de configuración (`web.xml`).
...
1.  **Construir el archivo WAR**: Empaqueta tu aplicación web [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") ([Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente."), Spring MVC, JSP, Servlets) en un archivo `.war`. (Ej. `mvn package` para Maven).
...
*   **Roles de Gestión**:
    ...
    *   `manager-script`: Acceso a la [API](/conocimiento/api "Una API (Application Programming Interface) es un conjunto de reglas, protocolos y herramientas que permite que diferentes aplicaciones de software se comuniquen entre sí.") del Manager (para scripts de automatización).
...
*   **Servir Estáticos con un Servidor Web Frontal**: Para alto rendimiento con archivos estáticos (imágenes, CSS, JS), es mejor usar un servidor web dedicado (Apache HTTP Server, [Nginx](/devops/nginx "Nginx (pronunciado 'engine-x') es un servidor web de alto rendimiento, servidor de correo reverso y balanceador de carga HTTP, diseñado para máxima concurrencia, eficiencia de recursos y bajo consumo de memoria.")) como [proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.") frontal que redirija solo las solicitudes dinámicas a Tomcat.
...
*   **Cambiar el Puerto por Defecto**: Si despliegas en un servidor público, cambia el puerto 8080 a 80 (o usa un [proxy](/arquitectura/design_patterns/estructurales/proxy "El patrón Proxy es un patrón estructural que proporciona un sustituto o intermediario para controlar el acceso a un objeto real, añadiendo comportamiento transversal sin modificar su implementación original.") inverso como Nginx/Apache que redirija del puerto 80 al 8080).
...
*   **[Spring Boot](/web/backend/framework/spring/spring-boot "¡Absolutamente! Spring Boot es un framework increíble para construir aplicaciones Java robustas y de alto rendimiento de manera rápida y eficiente.") y Tomcat Embebido**: Para la mayoría de las aplicaciones Spring Boot modernas, Tomcat viene embebido y preconfigurado, simplificando el despliegue. No necesitas un WAR o una instalación de Tomcat separada. Este cheatsheet es más relevante si despliegas WARs en un Tomcat "standalone".
...
Este cheatsheet te proporciona una referencia completa de Apache Tomcat, cubriendo sus conceptos esenciales, cómo instalarlo, configurarlo, desplegar aplicaciones, gestionar la seguridad y aplicar optimizaciones básicas, lo que te permitirá gestionar eficazmente tus aplicaciones web [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.").