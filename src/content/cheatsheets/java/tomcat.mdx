...
*   **JSP (JavaServer Pages)**: Una tecnología que permite incrustar código Java directamente en páginas HTML. Similar a [PHP](/php/php "PHP es un lenguaje de scripting del lado del servidor, diseñado principalmente para el desarrollo web."), pero para Java. Se compilan a Servlets.
