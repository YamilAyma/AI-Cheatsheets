---
title: "junit"
description: "JUnit es un framework de código abierto para escribir y ejecutar pruebas unitarias en Java."
...
**JUnit** es un framework de código abierto para escribir y ejecutar pruebas unitarias en [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos."). Permite a los desarrolladores asegurar la calidad de su código, detectar errores temprano y facilitar el refactoring. JUnit 5 (conocido como JUnit Jupiter) es la versión moderna y modular.
...
El mecanismo de extensión de JUnit 5. Permite integrar funcionalidades de terceros (ej. [Mockito](/java/mockito "Mockito es un framework de mocking para pruebas unitarias en Java."), Spring, etc.) o crear tus propias extensiones.
...
*   **Mocks y Stubs**: Utiliza frameworks de mocking (ej. [Mockito](/java/mockito "Mockito es un framework de mocking para pruebas unitarias en Java.")) para aislar la unidad bajo prueba de sus dependencias.
...
Este cheatsheet te proporciona una referencia completa de JUnit 5, cubriendo sus conceptos esenciales, cómo estructurar pruebas, las anotaciones clave, las aserciones, las pruebas parametrizadas y las mejores prácticas para escribir pruebas unitarias de [Java](/java/java "Java es un lenguaje de programación de propósito general, concurrente, basado en clases y orientado a objetos.") efectivas y robustas.